...
filename3 = "C:/Users/Gav/Desktop/Accommodation_Manager/test/my_file_with_dupes.csv"
...
for i in share_match_test: 
    ...
    aa = double_rooms.loc[double_rooms["Name"].str.contains(i, na=False)]
    bb = double_rooms.loc[double_rooms["Share with"].str.contains(i, na=False)]
...
for i in share_match_test: 
    ...
    aax = shared_rooms.loc[shared_rooms["Name"].str.contains(i, na=False)]
    bbx = shared_rooms.loc[shared_rooms["Share with"].str.contains(i, na=False)]
    
    comb = [aax, bbx]
    combine2 = pd.concat(comb)
    
    print("\nSharing Couples - Test 2:\n\n", combine2)
        
    filename3 = "C:/Users/Gav/Desktop/Accommodation_Manager/test/my_file_with_dupes.csv"

    export_csv = combine2.to_csv(filename3, mode='a', header=False)

dupe_removal_test = "C:/Users/Gav/Desktop/Accommodation_Manager/test/my_file_with_dupes.csv"
without_dupes = "C:/Users/Gav/Desktop/Accommodation_Manager/test/couples_test_" + date_data + "_" + time_data + ".csv"
...
os.remove("test/my_file_with_dupes.csv")
